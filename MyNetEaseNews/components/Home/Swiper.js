...
var Swiper = React.createClass({
    ...
    startTimer(){
        ...
        this.timer = this.setInterval(function () {
            ...
            this.setState({
              ...
              title: this.props.imageDataArr[activePage].title == 'undefined' ? '' : this.props.imageDataArr[activePage].title
            });
   ...
   onAnimationEnd(e){
      ...
      this.setState({
        ...
        // 标题
        title: this.props.imageDataArr[currentPage].title ? this.props.imageDataArr[currentPage].title : ''
      });
   }
